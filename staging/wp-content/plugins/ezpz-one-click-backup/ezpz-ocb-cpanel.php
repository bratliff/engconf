<?php
global $wpdb, $dataKey, $ezpz_ocb_cron_lock;

$status_file = EZPZOCB_URL . "/backups/data/status.$dataKey.php";
...
function getStatus() {
	...
	jQuery('#ezpz-next-scheduled').load('<?php echo EZPZOCB_URL . "/backups/data/cron-status.$dataKey.php?a=";?>' + jsTimestamp());
	
	jQuery("#bu-log-title").load('<?php echo EZPZOCB_URL . "/backups/data/buNum.$dataKey.php?a=";?>' + jsTimestamp());
		
	jQuery.ajax({
			url:'<?php echo EZPZOCB_URL . "/backups/data/backup-status.$dataKey.php?a=";?>' + jsTimestamp(),
				error:
					function(){
				...
				success:
					function (){
						jQuery("#backupStatus").load('<?php echo EZPZOCB_URL . "/backups/data/backup-status.$dataKey.php";?>');
	...
	jQuery.ajax({
			url:'<?php echo EZPZOCB_URL . "/backups/data/transfer-status.$dataKey.php?a=";?>' + jsTimestamp(),
				error:
					function(){
				...
				success:
					function (){
						jQuery("#transferStatus").load('<?php echo EZPZOCB_URL . "/backups/data/transfer-status.$dataKey.php?a=";?>' + jsTimestamp());
	...
	jQuery.ajax({
			url:'<?php echo EZPZOCB_URL . "/backups/data/error-status.$dataKey.php?a=";?>' + jsTimestamp(),
				error:
					function(){
				...
				success:
					function (){
						jQuery("#errorStatus").load('<?php echo EZPZOCB_URL . "/backups/data/error-status.$dataKey.php?a=";?>' + jsTimestamp());
...
function loadLogFile(clicked) {
	...
	jQuery('.inner-bu-log').hide();
	jQuery.ajax({
		<?php $loadKey =  EZPZOCB_URL . "/backups/data/directory.$dataKey.php?a="?>
