...
<div class="wrap">
    ...
    <table width="100%">
      ...
      <tr>
        <td height="35" colspan="3" align="left" valign="bottom"><input name="publish" lang="publish" class="button-primary" value="<?php echo @$submittext?>" type="submit" />
          <input name="publish" lang="publish" class="button-primary" onClick="FancyImg_redirect()" value="Cancel" type="button" /></td>
      </tr>
  ...
  <div class="tool-box">
    ...
    <form name="frm_FancyImg_display" method="post">
      ...
      <br />
      Note: Check official website <a href="http://www.gopiplus.com/work/2011/11/06/fancy-image-show-wordpress-plugin/">www.gopiplus.com</a> for live demo and more help. Don't upload your original images into plugin folder. if you upload the images into plugin folder, you may loose the images when you upate the plugin to next version.
</form>
  </div>
</div>
